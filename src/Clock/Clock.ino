 ...
 */
 ...
 // https://github.com/RalphBacon/No-Real-Time-Clock-RTC-required---use-an-NTP
...
#define _ssid     "Java Home"
#define _password "Polarstern"
...
void loop() {
  ...
  if (updateCount > (0.5 * _millisMinute)) {
    updateCount = 0;
    digitalClockDisplay();
  }
...
void displayBasicClock() {
  time_t t=now();
  int hourLED[] = {0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55};
  
  pixels.clear(); // Set all pixel colors to 'off'
  for(int b=0; b<12; b++) { 
    pixels.setPixelColor(b*5, pixels.Color(1, 1, 0));
  }
  pixels.setPixelColor(0, pixels.Color(25, 25, 0));
  pixels.setPixelColor(15, pixels.Color(25, 25, 0));
  pixels.setPixelColor(30, pixels.Color(25, 25, 0));
  pixels.setPixelColor(45, pixels.Color(25, 25, 0));

 //Now print all the elements of the time secure that it won't change under our feet
  pixels.setPixelColor(second(t), pixels.Color(0, 0, 5));
  pixels.setPixelColor(minute(t), pixels.Color(0, 0, 50));
  pixels.setPixelColor(hourLED[hour(t)+1], pixels.Color(50, 0, 0));
